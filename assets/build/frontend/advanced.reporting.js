...
AdvancedReporting.prototype.switchButtonsState = function (force = false) {
  const switchButtons = this.input.root.rootNode.querySelectorAll('.jet-form-builder__next-page, .jet-form-builder__prev-page');
