...
var _JetFBHooks = JetFBHooks,
    withRequestFields = _JetFBHooks.withRequestFields,
    withLoadingSelect = _JetFBHooks.withLoadingSelect;
...
addAction('mailchimp', compose(withSelect(withRequestFields), withSelect(withLoadingSelect))(MailChimpAction));
...
function GatewaysEditor(_ref) {
  ...
  var _useState = useState(GatewaysMeta),
      _useState2 = _slicedToArray(_useState, 2),
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (compose(withSelect(withSelectMeta('_jf_gateways')), withSelect(withSelectMeta('_jf_actions')))(GatewaysEditor));
...
function PluginGateways(_ref) {
  ...
  return wp.element.createElement(React.Fragment, null, wp.element.createElement(RadioControl, {
    ...
    return wp.element.createElement(React.Fragment, null, wp.element.createElement(_gateways_gateways_editor__WEBPACK_IMPORTED_MODULE_0__["default"], {
      isSaveAction: actionClick,
      onUnMount: onRequestClose,
      onSaveItems: function onSaveItems(newState) {
        return ChangeGateway(newState);
      }
    }));
  }));
}

/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (compose(withDispatch(withDispatchMeta('_jf_gateways', 'ChangeGateway')), withSelect(withSelectMeta('_jf_gateways')), withSelect(withSelectMeta('_jf_actions')))(PluginGateways));
