...
/***/ "./editor/form-actions/redirect-to-checkout.js":
/*!*****************************************************!*\
  !*** ./editor/form-actions/redirect-to-checkout.js ***!
  \*****************************************************/
/***/ (() => {
...
addAction('redirect_to_woo_checkout', function RedirectToWooCheckout(_ref) {
  var settings = _ref.settings,
      source = _ref.source,
      label = _ref.label,
      help = _ref.help,
  ...
  var _useState3 = useState([]),
      _useState4 = _slicedToArray(_useState3, 2),
      wcFields = _useState4[0],
      setWcFields = _useState4[1];

  var _useState5 = useState(true),
      _useState6 = _slicedToArray(_useState5, 2),
      wcDetailsModal = _useState6[0],
      setWcDetailsModal = _useState6[1];
  ...
  function saveWCDetails(items) {
    ...
    jQuery.ajax({
      ...
      if (!response.success) {
        ...
        JetActionWooCheckout.details = items; //setSource( { details: items } );
  ...
  return wp.element.createElement(React.Fragment, null, wp.element.createElement(BaseControl, {
    label: label('product_id_from')
  }, wp.element.createElement(RadioControl, {
    className: "jet-control-clear-full",
    options: source.product_id_from,
    selected: settings.product_id_from,
    onChange: function onChange(newVal) {
      return onChangeSetting(newVal, 'product_id_from');
    }
  })), 'manual' === settings.product_id_from && wp.element.createElement(TextControl, {
    label: label('product_id_manual'),
    value: settings.product_id_manual,
    onChange: function onChange(val) {
      return onChangeSetting(val, 'product_id_manual');
    }
  }), 'field' === settings.product_id_from && wp.element.createElement(SelectControl, {
    label: label('product_id_field'),
    labelPosition: "side",
    value: settings.product_id_field,
    options: formFields,
    onChange: function onChange(newVal) {
      return onChangeSetting(newVal, 'product_id_field');
    }
  }), wp.element.createElement(SelectControl, {
    ...
    onChange: function onChange(val) {
      return onChangeSetting(val, 'wc_price');
    },
    options: formFields
  }), wp.element.createElement(TextControl, {
    ...
    onChange: function onChange(val) {
      return onChangeSetting(val, 'wc_heading_order_details');
    }
  }), wp.element.createElement(BaseControl, {
    ...
    return wp.element.createElement(RepeaterWithState, {
      ...
      var currentItem = _ref4.currentItem,
          changeCurrentItem = _ref4.changeCurrentItem;
      return wp.element.createElement(React.Fragment, null, wp.element.createElement(TextControl, {
...
/* harmony import */ var _form_actions_redirect_to_checkout__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ./form-actions/redirect-to-checkout */ "./editor/form-actions/redirect-to-checkout.js");
/* harmony import */ var _form_actions_redirect_to_checkout__WEBPACK_IMPORTED_MODULE_12___default = /*#__PURE__*/__webpack_require__.n(_form_actions_redirect_to_checkout__WEBPACK_IMPORTED_MODULE_12__);
