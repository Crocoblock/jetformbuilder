      ...
      [
        ...
        _c("cx-vui-f-select", {
          attrs: {
            "options-list": [
              { value: 1, label: "Test" },
              { value: 2, label: "Test 22" },
              { value: 3, label: "Test 334" },
            ],
            multiple: true,
