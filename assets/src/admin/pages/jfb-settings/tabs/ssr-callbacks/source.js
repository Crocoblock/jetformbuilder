...
const label = {
	...
	pending: __( 'Pending Review', 'jet-form-builder' ),
...
const help = {
	...
	pending: __(
		'These custom function names were found in existing forms while updating. They are not active yet — approve the ones you trust to run with visitor-supplied data, or reject the rest.',
		'jet-form-builder',
	),
	blocked: __(
