...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": () => (__WEBPACK_DEFAULT_EXPORT__)\n/* harmony export */ });\n/* harmony import */ var _const_namespace_CurrentDate__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./const.namespace/CurrentDate */ \"./frontend/calculated.module/const.namespace/CurrentDate.js\");\n/* harmony import */ var _applyFilters__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./applyFilters */ \"./frontend/calculated.module/applyFilters.js\");\n/* harmony import */ var _const_namespace_Min_In_Sec__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./const.namespace/Min_In_Sec */ \"./frontend/calculated.module/const.namespace/Min_In_Sec.js\");\n/* harmony import */ var _const_namespace_Month_In_Sec__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./const.namespace/Month_In_Sec */ \"./frontend/calculated.module/const.namespace/Month_In_Sec.js\");\n/* harmony import */ var _const_namespace_Hour_In_Sec__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./const.namespace/Hour_In_Sec */ \"./frontend/calculated.module/const.namespace/Hour_In_Sec.js\");\n/* harmony import */ var _const_namespace_Day_In_Sec__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./const.namespace/Day_In_Sec */ \"./frontend/calculated.module/const.namespace/Day_In_Sec.js\");\n/* harmony import */ var _const_namespace_Year_In_Sec__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./const.namespace/Year_In_Sec */ \"./frontend/calculated.module/const.namespace/Year_In_Sec.js\");\nfunction _createForOfIteratorHelper(o, allowArrayLike) { var it = typeof Symbol !== \"undefined\" && o[Symbol.iterator] || o[\"@@iterator\"]; if (!it) { if (Array.isArray(o) || (it = _unsupportedIterableToArray(o)) || allowArrayLike && o && typeof o.length === \"number\") { if (it) o = it; var i = 0; var F = function F() {}; return { s: F, n: function n() { if (i >= o.length) return { done: true }; return { done: false, value: o[i++] }; }, e: function e(_e) { throw _e; }, f: F }; } throw new TypeError(\"Invalid attempt to iterate non-iterable instance.\\nIn order to be iterable, non-array objects must have a [Symbol.iterator]() method.\"); } var normalCompletion = true, didErr = false, err; return { s: function s() { it = it.call(o); }, n: function n() { var step = it.next(); normalCompletion = step.done; return step; }, e: function e(_e2) { didErr = true; err = _e2; }, f: function f() { try { if (!normalCompletion && it.return != null) it.return(); } finally { if (didErr) throw err; } } }; }\n\nfunction _unsupportedIterableToArray(o, minLen) { if (!o) return; if (typeof o === \"string\") return _arrayLikeToArray(o, minLen); var n = Object.prototype.toString.call(o).slice(8, -1); if (n === \"Object\" && o.constructor) n = o.constructor.name; if (n === \"Map\" || n === \"Set\") return Array.from(o); if (n === \"Arguments\" || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(n)) return _arrayLikeToArray(o, minLen); }\n\nfunction _arrayLikeToArray(arr, len) { if (len == null || len > arr.length) len = arr.length; for (var i = 0, arr2 = new Array(len); i < len; i++) { arr2[i] = arr[i]; } return arr2; }\n\n\n\n\n\n\n\n\nvar wpApplyFilters = wp.hooks.applyFilters;\n\nvar getStaticFunctions = function getStaticFunctions() {\n  return wpApplyFilters('jet.fb.static.functions', [_const_namespace_CurrentDate__WEBPACK_IMPORTED_MODULE_0__[\"default\"], _const_namespace_Min_In_Sec__WEBPACK_IMPORTED_MODULE_2__[\"default\"], _const_namespace_Month_In_Sec__WEBPACK_IMPORTED_MODULE_3__[\"default\"], _const_namespace_Hour_In_Sec__WEBPACK_IMPORTED_MODULE_4__[\"default\"], _const_namespace_Day_In_Sec__WEBPACK_IMPORTED_MODULE_5__[\"default\"], _const_namespace_Year_In_Sec__WEBPACK_IMPORTED_MODULE_6__[\"default\"]]);\n};\n/**\r\n * @type {BaseInternalMacro[]}\r\n */\n\n\nvar staticFunctions = [];\n/**\r\n * @param slug\r\n * @return {boolean|BaseInternalMacro}\r\n */\n\nfunction getFunction(slug) {\n  if (!staticFunctions.length) {\n    staticFunctions = getStaticFunctions();\n  }\n\n  var _iterator = _createForOfIteratorHelper(staticFunctions),\n      _step;\n\n  try {\n    for (_iterator.s(); !(_step = _iterator.n()).done;) {\n      var staticFunction = _step.value;\n      var current = new staticFunction();\n\n      if (current.getId() !== slug) {\n        continue;\n      }\n\n      return current;\n    }\n  } catch (err) {\n    _iterator.e(err);\n  } finally {\n    _iterator.f();\n  }\n\n  return false;\n}\n/**\r\n * @param current {String}\r\n * @param name {String}\r\n * @param filters {Filter[]}\r\n * @param root {Observable}\r\n * @return {*}\r\n */\n\n\nfunction attachConstNamespace(current, name, filters, root) {\n  if (!name.includes('CT::')) {\n    return current;\n  }\n\n  name = name.replace('CT::', '');\n  var staticFunc = getFunction(name);\n\n  if (false === staticFunc) {\n    return current;\n  }\n\n  return (0,_applyFilters__WEBPACK_IMPORTED_MODULE_1__[\"default\"])(staticFunc.getResult(), filters);\n}\n\n/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (attachConstNamespace);\n\n//# sourceURL=webpack:///./frontend/calculated.module/attachConstNamespace.js?");
