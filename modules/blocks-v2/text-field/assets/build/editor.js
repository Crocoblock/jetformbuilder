...
const variations = [{
  ...
  attributes: {
    field_type: 'url',
    name: 'url',
    label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_0__.__)('URL', 'jet-form-builder')
  },
  isActive: ['field_type', 'name']
}, {
  name: 'first-name',
