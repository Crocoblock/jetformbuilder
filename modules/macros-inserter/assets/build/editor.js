...
const withMacrosInserter = createHigherOrderComponent(BlockEdit => props => {
  ...
  return (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(Fragment, null, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(BlockControls, null, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(ToolbarGroup, null, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(MacrosFields, {
    withCurrent: true,
    onClick: (name, field) => {
      var _attributes$content;
      const htmlMacro = toHtmlMacro(name, field);
      setAttributes({
        content: ((_attributes$content = attributes.content) !== null && _attributes$content !== void 0 ? _attributes$content : '') + htmlMacro
      });
    }
