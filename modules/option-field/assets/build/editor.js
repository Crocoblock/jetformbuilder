...
function SelectRadioCheck(props) {
  ...
  }), 'generate' === field_options_from && (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(Notice, {
    status: "info",
    isDismissible: false
  }, __('Need a custom generator? Create one with this ', 'jet-form-builder'), (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("a", {
    href: "https://chatgpt.com/g/g-69ae892a8fe88191aeae6578c07d6211-jetformbuilder-create-custom-options-generators",
    target: "_blank",
    rel: "noopener noreferrer"
  }, __('assistant', 'jet-form-builder')), "."), getFieldOptionsForm(field_options_from, props), children);
}
...
function GeneratorSettings(props) {
  var _schemas$generatorId, _generatorData$schema, _generatorData$suppor, _generatorData$update, _generatorData$update2;
  const {
    attributes,
    setAttributes,
    editProps = {}
  ...
  const updateValueType = (_generatorData$update2 = generatorData.update_value_type) !== null && _generatorData$update2 !== void 0 ? _generatorData$update2 : 'scalar';
...
function isMultiValueField(field) {
  ...
  return ['jet-forms/checkbox-field'].includes(field.type) || field.multiple || field.allowMultiple;
}
function isUnsupportedAutoUpdateField(field) {
  if (!field) {
    return true;
  }
  return ['jet-forms/repeater-field', 'jet-forms/media-field', 'jet-forms/signature-field', 'jet-forms/drag-and-drop-file-upload', 'jet-forms/check-in-out'].includes(field.type);
}
...
function AutoUpdateControls({
  ...
  const blocks = useSelect(selectStore => {
    var _selectStore$getBlock;
    return (_selectStore$getBlock = selectStore('core/block-editor')?.getBlocks()) !== null && _selectStore$getBlock !== void 0 ? _selectStore$getBlock : [];
  }, []);
  ...
  const availableFields = useMemo(() => dataFields.filter(field => field.name !== currentFieldName && supportsValueType(field, updateValueType)), [currentFieldName, dataFields, updateValueType]);
  ...
  const selectedButtonId = useMemo(() => {
    ...
    const exactMatch = actionButtons.find(button => button.actionType === updateOnButton && (button.buttonClass || '') === (updateOnButtonClass || ''));
    if (exactMatch) {
      return exactMatch.id;
    }
    return actionButtons.find(button => button.actionType === updateOnButton)?.id || '';
  ...
  const buttonOptions = useMemo(() => {
    return [{
      ...
      value: btn.id,
      label: btn.buttonClass ? `${btn.label} (${btn.actionType}, ${btn.buttonClass})` : `${btn.label} (${btn.actionType})`
    }))];
  }, [actionButtons]);
  useEffect(() => {
    if (!updateOnButton) {
    ...
    const buttonStillExists = actionButtons.some(button => button.actionType === updateOnButton && (updateOnButtonClass ? button.buttonClass === updateOnButtonClass : true));
  ...
  useEffect(() => {
    var _nextListenFields$, _nextListenFields$2;
    ...
    setAttributes({
      generator_listen_field: singleListenField ? (_nextListenFields$ = nextListenFields[0]) !== null && _nextListenFields$ !== void 0 ? _nextListenFields$ : '' : nextListenFields.length <= 1 ? (_nextListenFields$2 = nextListenFields[0]) !== null && _nextListenFields$2 !== void 0 ? _nextListenFields$2 : '' : nextListenFields
    });
  ...
  return (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(Fragment, null, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(ToggleControl, {
  ...
  }, contextFields.map((hint, i) => (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    key: i,
    className: "components-base-control__help"
  }, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("p", null, hint.description), hint.example && (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("p", null, hint.example)))), autoUpdate && (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(SelectControl, {
    label: singleListenField ? __('Trigger Field', 'jet-form-builder') : __('Trigger Fields', 'jet-form-builder'),
    help: singleListenField ? __('Select the field that controls this generator.', 'jet-form-builder') : __('Select the fields that control this generator. Hold Ctrl (Windows) or Cmd (Mac) to select multiple.', 'jet-form-builder'),
    ...(!singleListenField && {
      multiple: true
    }),
    ...
    help: listenFieldArray.length > 1 ? __('When enabled, the options refresh only after every watched field has a value. Useful when multiple fields are needed together to filter results.', 'jet-form-builder') : __('When enabled, empty Trigger Field values use the generator-specific empty-state behavior. Generators with static fallback keep using their static settings; generators without fallback keep the list empty.', 'jet-form-builder'),
    ...
    help: __('Instead of refreshing automatically, options update only when a selected JetFormBuilder action button is clicked. Supported action types: Update Field, Next Page, Prev Page, Change Render State (submit is not supported). If the selected button has a CSS Class Name, auto-update first tries to match that exact button and falls back to the button type if no exact class match is found. If no CSS Class Name is set, the first matching button of the selected action type is used. In multi-step forms, "Next Page" is matched on the previous step and "Prev Page" is matched on the next step. Regular HTML buttons are not supported here. Leave empty to refresh instantly on watched field change.', 'jet-form-builder'),
    value: selectedButtonId,
    onChange: value => {
      const selectedButton = actionButtons.find(button => button.id === value);
      setAttributes({
...
/******/ })()
;
//# sourceMappingURL=data:application/json;charset=utf-8;base64,