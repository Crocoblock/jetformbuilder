<svg width="64" height="64" viewBox="0 0 64 64" fill="none" xmlns="http://www.w3.org/2000/svg">
	...
	<rect x="12" y="28" width="43" height="2" fill="#162B40"/>
	<circle cx="12" cy="29" r="5" fill="#4EFEC3" stroke="#162B40" stroke-width="2"/>
	<circle cx="55" cy="29" r="2" fill="#162B40" stroke="#162B40" stroke-width="2"/>
	<circle cx="37" cy="29" r="5" fill="#4EFEC3" stroke="#162B40" stroke-width="2"/>
</svg>
