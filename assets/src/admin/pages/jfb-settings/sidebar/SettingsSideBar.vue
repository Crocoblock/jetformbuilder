<template>
	<SideBarBoxes>
		...
		<template #content-help="box">
			<div class="help-center-link">
				<a :href="box.link_knowledge" target="_blank">
					<div class="help-center-link-icon">
					...
					<div class="help-center-link-label">{{ box.label_knowledge }}</div>
				</a>
			</div>
			<div class="help-center-link">
				<a :href="box.link_community" target="_blank">
					<div class="help-center-link-icon">
					...
					<div class="help-center-link-label">{{ box.label_community }}</div>
				</a>
			</div>
			<div class="help-center-link">
				<a :href="box.link_support" target="_blank">
					<div class="help-center-link-icon">
					...
					<div class="help-center-link-label">{{ box.label_support }}</div>
				</a>
			</div>
			<div class="help-center-link">
				<a :href="box.link_git" target="_blank">
					<div class="help-center-link-icon">
						<svg width="16" height="16" viewBox="0 0 16 16" fill="none"
							 xmlns="http://www.w3.org/2000/svg">
					...
					<div class="help-center-link-label">{{ box.label_git }}</div>
				</a>
			</div>
		</template>
	</SideBarBoxes>
...
<script>
const { SideBarBoxes } = JetFBComponents;

export default {
	name: 'SettingsSideBar',
	components: { SideBarBoxes },
};
</script>
