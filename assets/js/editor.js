...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (compose(withSelect(withSelectGatewaysLoading), withDispatch(withDispatchGateways))(PaypalMain));
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (compose(withSelect(withSelectFormFields([], '--')), withSelect(withSelectActionsByType('insert_post', true)), withSelect(withSelectGateways), withDispatch(withDispatchGateways))(PayNowScenario));
...
function PluginGateways(_ref) {
  ...
  return wp.element.createElement(React.Fragment, null, wp.element.createElement(RadioControl, {
    ...
    onUpdateClick: function onUpdateClick() {
      return closeModal(gatewayGeneral);
    },
