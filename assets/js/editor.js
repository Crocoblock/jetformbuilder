...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _components_macros_inserter__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../components/macros-inserter */ "./editor/components/macros-inserter.js");
/* harmony import */ var _helpers_action_helper__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../helpers/action-helper */ "./editor/helpers/action-helper.js");
/* harmony import */ var _helpers_blocks_helper__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../helpers/blocks-helper */ "./editor/helpers/blocks-helper.js");
/**
 * Internal dependencies
...
var _wp$components = wp.components,
    ...
    TextareaControl = _wp$components.TextareaControl,
    SelectControl = _wp$components.SelectControl;
Object(_helpers_action_helper__WEBPACK_IMPORTED_MODULE_1__["addAction"])('send_email', function SendEmailAction(_ref) {
  var settings = _ref.settings,
      source = _ref.source,
      label = _ref.label,
      help = _ref.help,
      onChangeSetting = _ref.onChangeSetting;
  var formFields = Object(_helpers_blocks_helper__WEBPACK_IMPORTED_MODULE_2__["getFormFieldsBlocks"])([], '--');
  ...
  }), wp.element.createElement(_components_macros_inserter__WEBPACK_IMPORTED_MODULE_0__["default"], {
    fields: formFields,
...
/* harmony import */ var _helpers_tools__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ./helpers/tools */ "./editor/helpers/tools.js");
...
Object(_helpers_tools__WEBPACK_IMPORTED_MODULE_13__["event"])('jet-form-builder-initialize')();
...
Object(_helpers_tools__WEBPACK_IMPORTED_MODULE_13__["event"])('jet-form-builder-initialized')();
...
/* harmony import */ var _helpers_hooks_helper__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../../helpers/hooks-helper */ "./editor/helpers/hooks-helper.js");
/* harmony import */ var _options__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./options */ "./editor/plugins/arguments/options.js");
function ownKeys(object, enumerableOnly) { var keys = Object.keys(object); if (Object.getOwnPropertySymbols) { var symbols = Object.getOwnPropertySymbols(object); if (enumerableOnly) symbols = symbols.filter(function (sym) { return Object.getOwnPropertyDescriptor(object, sym).enumerable; }); keys.push.apply(keys, symbols); } return keys; }
...
var _wp$components = wp.components,
    ...
    ToggleControl = _wp$components.ToggleControl;
function PluginArgs() {
  var _useMetaState = Object(_helpers_hooks_helper__WEBPACK_IMPORTED_MODULE_0__["useMetaState"])('_jf_args'),
  ...
  return wp.element.createElement(React.Fragment, null, wp.element.createElement(SelectControl, {
    ...
    options: _options__WEBPACK_IMPORTED_MODULE_1__["fieldsLayout"],
    onChange: function onChange(newVal) {
    ...
    options: _options__WEBPACK_IMPORTED_MODULE_1__["submitTypes"],
    onChange: function onChange(newVal) {
      setArgs(function (prevArgs) {
        return _objectSpread(_objectSpread({}, prevArgs), {}, {
          submit_type: newVal
...
function RegisterPlugins() {
  var sortedPlugins = [];
  var jfbPlugins = applyFilters('jet.fb.register.plugins', [_actions__WEBPACK_IMPORTED_MODULE_0__, _arguments__WEBPACK_IMPORTED_MODULE_1__]);
  jfbPlugins.forEach(function (plugin) {
    var name = plugin.base.name;
