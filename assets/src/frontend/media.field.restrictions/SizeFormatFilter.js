...
const symbols = {
	[ _x( 'TB', 'unit symbol', 'jet-form-builder' ) ]: (
		JetFormBuilderConst.Tb_In_Bytes
	),
	[ _x( 'GB', 'unit symbol', 'jet-form-builder' ) ]: (
		JetFormBuilderConst.Gb_In_Bytes
	),
	[ _x( 'MB', 'unit symbol', 'jet-form-builder' ) ]: (
		JetFormBuilderConst.Mb_In_Bytes
	),
	[ _x( 'KB', 'unit symbol', 'jet-form-builder' ) ]: (
		JetFormBuilderConst.Kb_In_Bytes
	),
