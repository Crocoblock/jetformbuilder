      ...
      _vm.storage.use_gateways
        ? _vm._l(_vm.gateways, function(tab, index) {
            return _c(
              ...
              {
                key: tab.component.name,
                attrs: { desc: tab.desc || "", label: tab.title }
              },
              [
                _c(
                  "keep-alive",
