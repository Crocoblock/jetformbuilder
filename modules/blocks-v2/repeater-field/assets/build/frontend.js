...
function collectRepeaterLinesFromTemplate(fieldNode, templateHtml) {
  ...
  rows.forEach(rowEl => {
    ...
    macroNodes.forEach(node => {
      ...
      node.textContent = (_valuesByName$macroNa = valuesByName[macroName]) !== null && _valuesByName$macroNa !== void 0 ? _valuesByName$macroNa : '';
    });
