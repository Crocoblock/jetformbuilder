...
function GatewaysEditor(_ref) {
  ...
  return wp.element.createElement(React.Fragment, null, renderGateway(gatewayGeneral.gateway, {
    ...
    onChange: function onChange(use_success_redirect) {
      setGateway({
        use_success_redirect: use_success_redirect
      });
    }
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (compose(withSelect(withSelectMeta('_jf_actions')), withSelect(withSelectGateways), withSelect(withSelectFormFields([], '--')), withDispatch(withDispatchGateways))(GatewaysEditor));
...
var _JetFBActions = JetFBActions,
    ...
    actionByTypeList = _JetFBActions.actionByTypeList;
var _JetFBHooks = JetFBHooks,
    withSelectGatewaysLoading = _JetFBHooks.withSelectGatewaysLoading,
    withSelectFormFields = _JetFBHooks.withSelectFormFields,
    withSelectGateways = _JetFBHooks.withSelectGateways,
    withDispatchGateways = _JetFBHooks.withDispatchGateways;
var _JetFBComponents = JetFBComponents,
...
function PayPal(_ref) {
  ...
  var use_global = gatewaySpecific.use_global,
      _gatewaySpecific$gate = gatewaySpecific.gateway_type,
      scenario = _gatewaySpecific$gate === void 0 ? 'PAY_NOW' : _gatewaySpecific$gate;
  ...
  var fetchArgs = additional.fetch[scenario] || {};
  useEffect(function () {
    setGatewayRequest({
      id: scenario
    });
  ...
  return wp.element.createElement(React.Fragment, null, wp.element.createElement(ToggleControl, {
    ...
    initialLabel: 'Fetch',
    label: 'Retry Fetch',
    apiArgs: _objectSpread(_objectSpread({}, fetchArgs), {}, {
      data: credits
    })
  })), renderGateway('paypal', {}, scenario));
}
registerGateway('paypal', compose(withSelect(withSelectGatewaysLoading), withDispatch(withDispatchGateways))(PayPal));

function PayNowScenario(_ref2) {
  var setGatewayRequest = _ref2.setGatewayRequest,
      gatewayGeneral = _ref2.gatewayGeneral,
      gatewaySpecific = _ref2.gatewaySpecific,
      setGateway = _ref2.setGateway,
      setGatewaySpecific = _ref2.setGatewaySpecific,
  ...
  return wp.element.createElement(React.Fragment, null, wp.element.createElement(TextControl, {
    ...
    options: actionByTypeList('insert_post', true),
    selected: gatewayGeneral.action_order,
    onChange: function onChange(action_order) {
      setGateway({
...
registerGateway('paypal', compose(withSelect(withSelectFormFields([], '--')), withSelect(withSelectGateways), withDispatch(withDispatchGateways))(PayNowScenario), 'PAY_NOW');
...
function PluginGateways(_ref) {
  ...
  return wp.element.createElement(React.Fragment, null, wp.element.createElement(RadioControl, {
    ...
    var actionClick = _ref2.actionClick,
        onRequestClose = _ref2.onRequestClose;
    return wp.element.createElement(React.Fragment, null, wp.element.createElement(_gateways_gateways_editor__WEBPACK_IMPORTED_MODULE_0__["default"], {
      isSaveAction: actionClick,
      onUnMount: onRequestClose,
      onSaveItems: function onSaveItems() {
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (compose(withDispatch(withDispatchMeta('_jf_gateways', 'ChangeGateway')), withDispatch(withDispatchGateways), withSelect(withSelectGateways), withSelect(withSelectMeta('_jf_gateways')), withSelect(withSelectMeta('_jf_actions')))(PluginGateways));
