...
namespace Jet_Form_Builder\Modules\Captcha\Turnstile;
...
use Jet_Form_Builder\Modules\Captcha\Abstract_Captcha\Base_Captcha_From_Options;
...
class Turnstile extends Base_Captcha_From_Options implements
	...
	public function enqueue_editor_script() {
		wp_enqueue_script(
			...
			$this->module()->get_url( 'assets-build/js/turnstile/editor{min}.js' ),
			array(),
	...
	public function register_frontend_scripts() {
		...
		wp_register_script(
			$handle,
			$this->module()->get_url( 'assets-build/js/turnstile/frontend{min}.js' ),
